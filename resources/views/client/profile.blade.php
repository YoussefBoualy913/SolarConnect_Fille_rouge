            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="bg-surface-container-low p-8 rounded-xl">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-xl font-bold font-headline">Adresses d'installation</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Address Card 1 -->
                        <div class="bg-surface-container-lowest p-5 rounded-xl flex items-start gap-4">
                            <div
                                class="w-10 h-10 bg-tertiary-container/20 rounded-lg flex items-center justify-center text-tertiary">
                                <span class="material-symbols-outlined"
                                    style="font-variation-settings: 'FILL' 1;">home</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="font-bold text-on-surface mb-1">Résidence Principale</h3>
                                <p class="text-sm text-on-surface-variant leading-relaxed">42 Avenue des
                                    Champs-Élysées<br />75008 Paris, France</p>
                                <div class="mt-4 flex gap-3">
                                    <button class="text-xs font-bold text-primary">Modifier</button>
                                    <button class="text-xs font-bold text-on-surface-variant">Supprimer</button>
                                </div>
                            </div>
                        </div>
                        <!-- Address Card 2 -->
                        <div class="bg-surface-container-lowest p-5 rounded-xl flex items-start gap-4">
                            <div
                                class="w-10 h-10 bg-secondary-container/30 rounded-lg flex items-center justify-center text-secondary">
                                <span class="material-symbols-outlined">bungalow</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="font-bold text-on-surface mb-1">Maison de Vacances</h3>
                                <p class="text-sm text-on-surface-variant leading-relaxed">Chemin des Vignes<br />83310
                                    Grimaud, France</p>
                                <div class="mt-4 flex gap-3">
                                    <button class="text-xs font-bold text-primary">Modifier</button>
                                    <button class="text-xs font-bold text-on-surface-variant">Supprimer</button>
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div class="w-16 h-16 rounded-full bg-surface-container mb-4 flex items-center justify-center">
                            <span class="material-symbols-outlined text-3xl text-primary"
                                style="font-variation-settings: 'wght' 200;">support_agent</span>
                        </div>
                        <h3 class="font-bold text-on-surface mb-1">Besoin d'aide ?</h3>
                        <p class="text-xs text-on-surface-variant mb-4">Notre équipe de support est disponible 24/7
                            pour vos questions techniques.</p>
                        <button
                            class="w-full py-2 bg-surface-container-high text-on-surface font-bold rounded-lg text-sm hover:bg-surface-variant transition-colors">
